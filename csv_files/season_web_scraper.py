...
table_id = "9732"  # the randomly generated id that is assigned to the table in html
...
headerRow = soup.find("table", id="table-{}".format(table_id)).find("thead").find_all('tr')[0].find_all('th')
del headerRow[0]
header = ""
